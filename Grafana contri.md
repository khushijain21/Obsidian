...
![[Pasted image 20230409174711.png]]

https://github.com/grafana/grafana/issues/65613

Memoization in react: - https://rossbulat.medium.com/how-to-memoize-in-react-3d20cbcd2b6e
...
```
npm config set prefix $NVM_DIR/versions/node/v18.16.0
```
...
Dashboard: Navigating to a dashboard
